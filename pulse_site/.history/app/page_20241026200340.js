        ...
        <div className="mb-4"> 
          ...
          <div className="relative">
            <div>
              <button
                type="button"
                className="inline-flex w-full justify-start gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                id="menu-button"
              ...
              >
                {companyType || ""}
                <svg className="flex justify-self-end -mr-1 h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
