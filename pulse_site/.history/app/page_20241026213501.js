      ...
      >
        ...
        <div className="mb-4"> 
          ...
          <div className="relative">
            ...
            >
              <span className="flex-grow text-left">{state ? states[state] : "Select a State"}</span>
              <svg
                className="h-5 w-5 text-gray-400"
                viewBox="0 0 20 20"
                fill="currentColor"
            ...
            {isStateOpen && (
              <div
                className="absolute left-0 z-10 mt-2 w-56 origin-top-left divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none max-h-50 overflow-y-auto" // Add max height and overflow for scrolling
                role="menu"
                aria-orientation="vertical"
                aria-labelledby="menu-button"
              >
